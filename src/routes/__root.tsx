...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { property: "og:description", content: "AutoFix.sh detects failed GitHub Actions, generates AI fixes, validates them in sandboxes, and commits patches automatically." },
      { property: "og:type", content: "website" },
      { name: "twitter:title", content: "AutoFix.sh — AI-powered self-healing deployment agent" },
      { name: "twitter:description", content: "AutoFix.sh detects failed GitHub Actions, generates AI fixes, validates them in sandboxes, and commits patches automatically." },
      { property: "og:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e78b3b2c-0a00-4603-9696-784cc9da0c15/id-preview-0084bdae--98872a8b-e385-4a2f-bb2c-c5701e783976.lovable.app-1779857681227.png" },
      { name: "twitter:image", content: "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e78b3b2c-0a00-4603-9696-784cc9da0c15/id-preview-0084bdae--98872a8b-e385-4a2f-bb2c-c5701e783976.lovable.app-1779857681227.png" },
