  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section className="relative z-10 mx-auto max-w-7xl px-6 pb-24 pt-16 text-center">
        ...
        >
          AI-powered <span className="text-foreground/60">self-healing</span>
          <br />
          deployment agent.
        </h1>
        <p
        ...
        >
          AutoFix.sh watches your GitHub Actions, diagnoses failures with AI, validates patches
          inside isolated sandboxes, and commits the fix straight to your PR.
        </p>
        <div
          ...
          <div className="relative overflow-hidden rounded-xl border border-border bg-terminal shadow-2xl">
            <div className="flex items-center gap-2 border-b border-border bg-surface px-4 py-2.5">
              ...
              <span className="ml-2 font-mono text-xs text-muted-foreground">
                autofix-agent · acme-corp/api-gateway
              </span>
              <span className="ml-auto rounded bg-success/10 px-2 py-0.5 text-[10px] font-mono text-success border border-success/30">
                healed
              </span>
            </div>
            <pre className="overflow-x-auto px-5 py-5 text-left font-mono text-[13px] leading-6">
              ...
              <span className="text-muted-foreground">[14:02:11]</span>{" "}
              <span className="text-destructive">✕ build failed</span> · TypeError: Cannot read 'id'
              of undefined
              <span className="text-muted-foreground">[14:02:13]</span>{" "}
              <span className="text-primary">→ analyzing stderr (24 lines)…</span>
              <span className="text-muted-foreground">[14:02:18]</span>{" "}
              <span className="text-primary">→ patch generated</span> · src/handlers/user.ts{" "}
              <span className="text-muted-foreground">(+2 -1)</span>
              <span className="text-muted-foreground">[14:02:22]</span>{" "}
              <span className="text-primary">→ sandbox: npm test</span>
              <span className="text-muted-foreground">[14:02:41]</span>{" "}
              <span className="text-success">✓ 247 tests passed</span>
              <span className="text-muted-foreground">[14:02:43]</span>{" "}
              <span className="text-success">✓ committed</span> 4f8e2d1 → PR #842
        ...
        <div className="grid gap-12 md:grid-cols-2 md:items-center">
          <div>
            ...
            <h2 className="mt-3 text-3xl font-semibold tracking-tight md:text-4xl">
              CI failures are a tax on velocity.
            </h2>
            <p className="mt-4 text-muted-foreground leading-relaxed">
              Every red build costs context switches: open logs, read traces, debug locally, push
              again, wait. AutoFix.sh removes the loop.
            </p>
          </div>
